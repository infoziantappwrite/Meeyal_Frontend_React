    ...
    const fetchProducts = async () => {
      try {
        ...
        const fetchedProducts = data.map((doc) => {
          ...
          if (
            Array.isArray(doc.productImages) &&
            doc.productImages.length > 0
          ) {
                        ...
                        <div className="block_box">
                          <div className="custom-navigation">
                            <button
                              className="owl-prev"
                              onClick={() =>
                                swiperRefs.current[category]?.slidePrev()
                              }
                            >
                              <i
                            ...
                            <button
                              className="owl-next"
                              onClick={() =>
                                swiperRefs.current[category]?.slideNext()
                              }
                            >
                              <i
