...
const FilterComponent = ({ onApplyFilters, subCategoryId, allSubcategories }) => {
  ...
  const [selectedSubcat, setSelectedSubcat] = useState(subCategoryId); // Default selected subcat
  ...
  useEffect(() => {
    if (isFirstRender.current) {
      ...
      onApplyFilters({
        ...
        limit,
        viewMode,
        subcategory: selectedSubcat // Pass selected subcategory
      });
    }
  }, [selectedPrice, sortOption, limit, viewMode, selectedSubcat, onApplyFilters]);
  ...
  return (
    <div className="category-info p-2">
      <div className="row align-items-center justify-content-between flex-nowrap">
        ...
        <div className="col-auto d-none d-md-flex align-items-center">
          <span className="me-2 text-white">Subcategory:</span>
        <select
