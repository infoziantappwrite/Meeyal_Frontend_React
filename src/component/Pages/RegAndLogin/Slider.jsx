      ...
      <div className="account-content list-group">
        <div className="box-content">
          ...
          <ul className="list-unstyled">
            ...
            <li>
              <Link to="/forgot-password" className="list-group-item">
                Forgotten Password
              </Link>
            </li>
            <li>
              <Link to="/my-account" className="list-group-item">
                My Account
              </Link>
            </li>
            <li>
              <Link to="/order-history" className="list-group-item">
                Order History
              </Link>
            </li>
            <li>
              <button
                ...
                className="list-group-item logout-btn"
              >
                Logout
              </button>
            </li>
