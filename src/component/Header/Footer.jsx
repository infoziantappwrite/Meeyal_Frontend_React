                                    ...
                                    <ul class="list-unstyled">
                                        ...
                                        <li>
                                            <div class="phone">
                                                ...
                                                <div class="contact_site"><a href="tel:+91123456789" class="contact_site">+91 123 456 789</a></div>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="fax">
                                ...
                                <div class="position-footer-right">
                                    ...
                                    <div class="payment-link">
                                        ...
                                        <div class="payment-method">
                                            <a href="index.html#"><i class="fa-brands fa-cc-visa"></i></a>
                                            <a href="index.html#"><i class="fa-brands fa-cc-mastercard"></i></a>
                                            <a href="index.html#"><i class="fa-brands fa-cc-paypal"></i></a>
                                            <a href="index.html#"><i class="fa-brands fa-cc-discover"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
